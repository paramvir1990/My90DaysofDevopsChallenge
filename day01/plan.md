...
>> DevOps for me is managing infrastruture, operations and handling releases. Cloud Engineering is doing the same on Cloud.


Why you are starting learning DevOps & Cloud?
>> For upgrading my skill, for curiosity , for staying relevant, for money.
...
>> Will try to solve one problem every day.
